   ...
   * ******************************************************************** *
   *                                                                      *
   *   Replicating results for Behavioral Variables and                   *
   *          Motivation Variables using differnt matching techniques     *                               *
   *                                                                      *       
   *                                                                      *
   *                                                                      *                       
   *                                                                      *
   ...
   * ******************************************************************** *
       ...
       ** OUTLINE:      PART 0: Forest Basal Area
						...
						PART 2: Motivation variable
						PART 3: DiD for Behavior Variables
						PART 2: DiD for Motivation Variable
...
*\ nnmatch3 for motivation variable -full sample and different sub-sample. 
******************************** 
